...
alpha_s = 0.345 # Strong coupling constant (dimensionless, same in any unit system)
sigma = 0.19 #GeV^2  # String tension in GeV^2
 
m_c = 4.8 # charm quark mass in GeV
...
def hamiltonian_matrix_element(n1, l, n2, r, dr):
    ...
    V = -(np.sum(R_n1 * R_n2 * (((4 / 3) * alpha_s / (r)) - (sigma * (r))) * r**2) * dr)
